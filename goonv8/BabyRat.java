...
/*
        ...
        */
        ...
        if(catTurnsLeft > 0 && catLoc != null) {
            catTurnsLeft -= 1;
            babyRatMicro();
            if(G.rc.getCurrentRatCost() >= 70) Motion.bugnavAwayNoTurning(catLoc);
        ...
        if(cat != null) {
            ...
            //if(Motion.canCatReachYou(cat.getLocation())) {
                ...
                catTurnsLeft = 1;
                babyRatMicro();
                if(G.rc.getCurrentRatCost() >= 70) Motion.bugnavAwayNoTurning(cat.getLocation());
        ...
        if(babyRat != null) {
            ...
            */
            ...
            if ((G.rc.getCurrentRatCost() > (70 + 5 * kings.size()) && G.rc.getGlobalCheese() > 1200 && G.rc.getRoundNum() < 1200 && kings.size() < 5) || (G.rc.getRoundNum() > 1940 && kings.size() == 1)) {
    ...
    public static void babyRatMicro() throws Exception {
        ...
        for(Direction d : Direction.allDirections()) {
            if(G.rc.canAttack(G.rc.getLocation().add(d))) {
                int cheeseToUse = Math.min(G.rc.getGlobalCheese(), 1);
                if(G.rc.getRawCheese()/2 >= 10) {
                    cheeseToUse = G.rc.getRawCheese();
                }
