...
public class RatKing {
    ...
    public static void run() throws Exception {
        ...
        else if(G.rc.getCurrentRatCost() <= 30 && G.rc.getGlobalCheese() - G.rc.getCurrentRatCost() >= 1500) {
            spawnRats();
        }
        else if(G.rc.getCurrentRatCost() <= 20 && G.rc.getGlobalCheese() - G.rc.getCurrentRatCost() >= 1200) {
            spawnRats();
        }
